    ...
    $.post("./post_requests_handler.php", { getFeedPosts: true, offset: offset, limit: limit }, function (result) {
        ...
        result.posts.forEach(post => {
            ...
            setInterval(function () {
                $.post("./post_requests_handler.php", { getPostLikesNumber: true, post_id: post.post.post_id }, function (likesNumber) {
                ...
                if (!postCommentsDiv.hidden) {
                    $.post("./post_requests_handler.php", { getPostComments: true, post_id: post.post.post_id }, function (comments) {
