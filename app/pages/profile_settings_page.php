<div class="edit-profile-image">
    <form id="edit-profile-form" action="">
        ...
        <label for="edit-username">Edit username</label><input id="edit-username" type="text" />
        <label for="edit-password">Edit password</label><input id="edit-password" type="password" />
